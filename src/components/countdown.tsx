...
const COUNTDOWN_FROM = "2024-08-15";
...
const ShiftingCountdown = () => {
  return (
    <div className="bg-gradient-to-br from-violet-600 to-indigo-600 p-4 h-screen">
      <div className="mx-auto flex w-full max-w-5xl items-center bg-white h-full">
